...
-- DECLARE START TIME & CREATE LOG TABLE.
DECLARE @RunDate DATETIME;
SET @RunDate = (SELECT GETDATE());
PRINT @RunDate;
CREATE TABLE #CMTAsso_LogSummary (
...
INSERT INTO #CMTAsso_LogSummary (RunTime, StepName, RecordCount, TimeFinished)
 VALUES (@RunDate, 'Asso_BusinessLKP', @@ROWCOUNT, GETDATE())
;
...
INSERT INTO #CMTAsso_LogSummary (RunTime, StepName, RecordCount, TimeFinished)
 VALUES (@RunDate, 'Asso_NewAssociations', @@ROWCOUNT, GETDATE())
;
...
INSERT INTO #CMTAsso_LogSummary (RunTime, StepName, RecordCount, TimeFinished)
 VALUES (@RunDate, 'Asso_FirstLoginDate', @@ROWCOUNT, GETDATE())
;
...
INSERT INTO #CMTAsso_LogSummary (RunTime, StepName, RecordCount, TimeFinished)
 VALUES (@RunDate, 'Asso_NewStartDate', @@ROWCOUNT, GETDATE())
;
...
INSERT INTO #CMTAsso_LogSummary (RunTime, StepName, RecordCount, TimeFinished)
 VALUES (@RunDate, 'Asso_RecentLoginDate', @@ROWCOUNT, GETDATE())
;
...
INSERT INTO #CMTAsso_LogSummary (RunTime, StepName, RecordCount, TimeFinished)
VALUES (@RunDate, 'Asso_NewSeqNum', @@ROWCOUNT, GETDATE())
;
...
INSERT INTO #CMTAsso_LogSummary (RunTime, StepName, RecordCount, TimeFinished)
VALUES (@RunDate, 'Asso_LocPermData', @@ROWCOUNT, GETDATE())
;
...
--  order by Email
 ...
 INSERT INTO #CMTAsso_LogSummary (RunTime, StepName, RecordCount, TimeFinished)
 VALUES (@RunDate, 'Asso_CanclDates', @@ROWCOUNT, GETDATE())
;
...
INSERT INTO #CMTAsso_LogSummary (RunTime, StepName, RecordCount, TimeFinished)
VALUES (@RunDate, 'Asso_SuccDailyLogn', @@ROWCOUNT, GETDATE())
;		
...
INSERT INTO #CMTAsso_LogSummary (RunTime, StepName, RecordCount, TimeFinished)
VALUES (@RunDate, 'Asso_UpdFirstLognDt', @@ROWCOUNT, GETDATE())
;

IF OBJECT_ID('Sandbox.dbo.CMTAsso_LogSummary', 'U') IS NOT NULL
 INSERT INTO Sandbox.dbo.CMTAsso_LogSummary
 SELECT DISTINCT *
 FROM #CMTAsso_LogSummary
;
